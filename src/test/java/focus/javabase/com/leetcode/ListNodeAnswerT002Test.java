...
public class ListNodeAnswerT002Test {
    ...
    public void addTwoNumbers() {
        ...
        ListNode resultListNode = ListNodeT002.addTwoNumbersAnswer(listNode1, listNode2);
    ...
    public void addTwoNumbers5() {
        ...
        ListNode resultListNode = ListNodeT002.addTwoNumbersAnswer(listNode1, null);
        while (resultListNode != null) {
            /**except output [8，9,9]**/
            targetList.add(resultListNode.val);
            resultListNode = resultListNode.next;
