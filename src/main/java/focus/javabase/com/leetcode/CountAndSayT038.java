...
public class CountAndSayT038 {
    ...
    public static String say(String str) {
        ...
        while (subStr.length() != 0) {
            String key = subStr.charAt(subStr.length() - 1) + "";
        ...
        while (iterator.hasNext()) {
            ...
            outStr += obj.getKey() + obj.getValue();
        }
        return outStr;
    }

    // 312211  13112221
    public static String say1(String str) {
        Integer count = 1;
